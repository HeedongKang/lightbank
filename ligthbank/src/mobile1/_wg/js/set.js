...
*****************************************************************************************************************************************************/
    ...
    // 운영시간
    v.time1 = "오전 10:00 ~ 오후 05:00"; //평일
    v.time2 = "오후 12:00 ~ 오후 01:00"; //점심
    v.time3 = "토 / 일 / 공휴일은 휴무"; //휴무
    ...
    // 반품배송지
    v.returnAdd1 = "경기도 파주시 숲속노을로 30-3 (동패동)";
    ...
    // 에스크로
    v.escrow1 = "NHN KCP";
    a.escrow2 = "http://www.kcp.co.kr/"; //해당 카드사에서 제공하는 링크를 넣어주세요.
    ...
    a.naverTalk = "http://talk.naver.com/WC5PIH";
    ...
    v.YellowID = "@디자인웹굿";
    a.YellowID = "http://plus.kakao.com/home/@디자인웹굿";
